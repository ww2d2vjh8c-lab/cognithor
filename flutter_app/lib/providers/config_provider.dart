...
class ConfigProvider extends ChangeNotifier {
  ...
  static Map<String, dynamic> _defaults() => {
    ...
    'executor': {
      ...
      'media_analyze_image_timeout': 30,
      'media_transcribe_audio_timeout': 60,
      'media_extract_text_timeout': 30,
      'media_tts_timeout': 15,
    ...
    'web': {
      ...
      'search_and_read_max_chars': 80000,
      'http_request_max_body_bytes': 10000000,
