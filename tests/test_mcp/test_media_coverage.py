...
class TestValidateInputPath:
    def test_valid_path(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        f = tmp_path / "test.txt"
        f.write_text("x")
...
class TestAnalyzeDocument:
    ...
    @pytest.mark.asyncio
    async def test_empty_text(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_success(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        f = tmp_path / "doc.txt"
    ...
    @pytest.mark.asyncio
    async def test_short_text_ocr_warning(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_llm_exception(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        f = tmp_path / "doc.txt"
    ...
    @pytest.mark.asyncio
    async def test_save_to_vault(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        f = tmp_path / "vault_doc.txt"
    ...
    @pytest.mark.asyncio
    async def test_save_to_vault_failure(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        f = tmp_path / "vault_fail.txt"
...
class TestExportDocument:
    ...
    async def test_unsupported_format(self, pipeline: MediaPipeline) -> None:
        result = await pipeline.export_document("inhalt", fmt="xlsx")
...
class TestConvertAudioCoverage:
    ...
    @pytest.mark.asyncio
    async def test_convert_success(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
    ...
    @pytest.mark.asyncio
    async def test_convert_ffmpeg_error(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
...
class TestResizeImageCoverage:
    @pytest.mark.asyncio
    async def test_resize_success(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        f = tmp_path / "img.png"
    ...
    @pytest.mark.asyncio
    async def test_resize_exception(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
...
class TestGeneratePdfDocx:
    def test_generate_pdf_import_error(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
    ...
    def test_generate_docx_import_error(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        out = tmp_path / "out.docx"
        with patch.dict("sys.modules", {"docx": None, "docx.shared": None}):
            with pytest.raises(ImportError, match="python-docx"):
                pipeline._generate_docx(out, "Inhalt", "Titel", "Autor")

    def test_generate_pdf_success(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        out = tmp_path / "out.pdf"
        mock_pdf = MagicMock()
    ...
    def test_generate_docx_success(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        out = tmp_path / "out.docx"
...
class TestImageTooLarge:
    @pytest.mark.asyncio
    async def test_image_too_large(self, pipeline: MediaPipeline, tmp_path: Path) -> None:
        f = tmp_path / "huge.jpg"
